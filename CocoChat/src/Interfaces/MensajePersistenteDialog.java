...
public class MensajePersistenteDialog extends JDialog {

    public MensajePersistenteDialog(JFrame parent, String destinatario) {
        super(parent, "Mensaje a amigo", true);
        setSize(450, 330);
        ...
        JLabel title = new JLabel("Mensaje a: " + destinatario);
        title.setFont(new Font("Segoe UI", Font.BOLD, 16));
        title.setAlignmentX(Component.CENTER_ALIGNMENT);

        JLabel info = new JLabel("<html><div style='text-align:center;'>Este mensaje se guardará en el chat de amigos y será visible cuando el destinatario esté en línea.<br>Si está offline, guardar como pendiente.</div></html>");
        ...
        enviar.addActionListener((ActionEvent e) -> {
            JOptionPane.showMessageDialog(this, "Mensaje guardado y enviado.");
            dispose();
        });
