...
public class MensajeGrupoDialog extends JDialog {

    public MensajeGrupoDialog(JFrame parent, String grupo) {
        super(parent, "Mensaje a grupo", true);
        setSize(450, 300);
        ...
        JLabel title = new JLabel("Enviar al Grupo: " + grupo);
        title.setFont(new Font("Segoe UI", Font.BOLD, 16));
        title.setAlignmentX(Component.CENTER_ALIGNMENT);

        JLabel info = new JLabel("<html><div style='text-align:center;'>Este mensaje será visible para todos los miembros del grupo.</div></html>");
        ...
        JButton enviar = new JButton("Enviar al Grupo");
        ...
        enviar.addActionListener((ActionEvent e) -> {
            JOptionPane.showMessageDialog(this, "Mensaje enviado al grupo.");
            dispose();
        });
